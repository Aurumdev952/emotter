...
const Layout: NextPage<LayoutProps> = ({ children }) => {
  ...
  return (
    <>
      <main data-theme="dark" suppressHydrationWarning className="container bg-[#0d1726]">
        <div className="menu hidden flex-col items-center justify-start gap-5 border-r-[.01rem] border-slate-700 py-10 lg:flex">
          ...
          <Button className="flex w-[10rem] justify-start pl-6 hover:text-white">
