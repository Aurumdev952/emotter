...
const Post: NextPage = () => {
    const id = "";
    const { data: tweet, isLoading, isError } = api.tweet.getTweet.useQuery(id);
    return (
    <>
      <Head>
        <title>Emotter</title>
      ...
      <Layout>
        <div className="w-full pt-10">
          <div className="glass absolute left-0 top-0 z-10 flex h-10 w-full items-center justify-start gap-3 pl-4 pt-1">
            ...
            <p className="leading-7">Home</p>
          </div>
          {!!tweet && <div className="w-full flex flex-col justify-start gap-2"><Tweet {...tweet} /></div>}
